...
import { Recycle, Droplets, TreeDeciduous, Users, Building2, Send, ChevronDown, MapPin, Mail, Phone, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      <header className="relative h-screen flex items-center justify-center bg-gradient-to-br from-emerald-600 via-emerald-500 to-teal-400 text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-3xl mb-12 leading-relaxed font-light">
            Juntos por uma cidade mais sustentável e consciente
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Aprenda a separar corretamente seus resíduos e faça parte da mudança que Curitiba precisa. 
                A coleta seletiva é fundamental para reduzir o impacto ambiental e promover a sustentabilidade.
              </p>
        ...
        <Section alternate>
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                Localize facilmente os pontos de coleta de materiais recicláveis e resíduos especiais em Curitiba.
                Nossa rede de parceiros está sempre pronta para receber seus materiais.
              </p>
              <Button>
        ...
        <Section>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Trabalhamos com as melhores cooperativas e empresas de reciclagem da cidade
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-12">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Transformando nossa cidade através da conscientização ambiental.
              </p>
            </div>
            <div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Curitiba Limpa. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
